  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <a href="${pageContext.request.contextPath}/nhankhau"
        ><i class="fas fa-users"></i> Quản lý nhân khẩu
      </a>
    ...
    <div class="container-m">
      ...
      <div class="mb-3 text-end">
        <a
          href="${pageContext.request.contextPath}/nhankhau/add"
        ...
        <tbody>
          <c:forEach var="nk" items="${nhanKhaus}">
            <tr class="text-center">
              ...
              <td>
                <a
                  href="${pageContext.request.contextPath}/nhankhau/edit/${nk.id}"
                  class="btn btn-warning btn-sm"
                  >Sửa</a
                >
                <a
                  href="${pageContext.request.contextPath}/nhankhau/delete/${nk.id}"
                  class="btn btn-danger btn-sm"
                  onclick="return confirm('Bạn có chắc chắn muốn xóa nhân khẩu này chứ?');"
                  >Xóa</a
                >
              </td>
            </tr>
