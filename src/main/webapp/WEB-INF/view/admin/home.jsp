  ...
  <body>
    ...
    <div class="container-m">
      <a href="${pageContext.request.contextPath}/nhankhau" class="function">
        <img
          src="${pageContext.request.contextPath}/resources/images/nhan_khau.webp"
          alt="Nhan_khau"
        />
      ...
      <a href="${pageContext.request.contextPath}/fees" class="function">
        <img
          src="${pageContext.request.contextPath}/resources/images/phi.webp"
          alt="Phi"
        />
      ...
      >
        <img
          src="${pageContext.request.contextPath}/resources/images/payment-methods.webp"
          alt="payment-methods"
        />
