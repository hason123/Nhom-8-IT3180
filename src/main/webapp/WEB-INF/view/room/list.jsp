  ...
  <body>
    ...
    <div class="container-m">
      ...
      <div class="mb-3 text-end">
        <a
          href="${pageContext.request.contextPath}/rooms/add"
        ...
        <tbody>
          <c:forEach var="room" items="${rooms}">
            <tr class="text-center">
              ...
              <td>
                <a
                  href="${pageContext.request.contextPath}/rooms/edit/${room.idRoom}"
                  class="btn btn-warning btn-sm"
                  >Sửa</a
                >
                <a
                  href="${pageContext.request.contextPath}/rooms/delete/${room.idRoom}"
